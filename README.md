...
[![Kotlin Multiplatform](https://img.shields.io/badge/Kotlin_Multiplatform-2.3.10-7F52FF?logo=kotlin&logoColor=white)](https://kotlinlang.org/docs/multiplatform.html)
[![Android](https://img.shields.io/badge/Android-AGP%209.1.0-3DDC84?logo=android&logoColor=white)](https://developer.android.com)
[![iOS](https://img.shields.io/badge/iOS-Supported-8E8E93?logo=apple&logoColor=white)](https://developer.apple.com)
[![Gradle](https://img.shields.io/badge/Gradle-9.4.0-02303A?logo=gradle&logoColor=white)](https://gradle.org)
...
Kotlin Multiplatform (KMP) project targeting **Android** and **iOS**, with a shared module and
platform-specific app entry points.
...
The **shared** module is set up for Maven publication via
...
It is recommended to run [kdoctor](https://github.com/Kotlin/kdoctor) to check that your environment
is correctly configured for Kotlin Multiplatform. kdoctor reports and can help fix common setup
issues.
